...
class CreateAuthTables extends Migration
{
    public function up()
    {
         ...
         */
        $this->forge->addField([
            'id'               => ['type' => 'int', 'constraint' => 2, 'unsigned' => true, 'auto_increment' => true],
            ...
            'avatar'           => ['type' => 'varchar', 'constraint' => 128, 'null' => true],
            'reset_hash'       => ['type' => 'varchar', 'constraint' => 128, 'null' => true],
            'reset_at'         => ['type' => 'datetime', 'null' => true],
            'reset_expires'    => ['type' => 'datetime', 'null' => true],
            'activate_hash'    => ['type' => 'varchar', 'constraint' => 128, 'null' => true],
            'status'           => ['type' => 'varchar', 'constraint' => 7, 'null' => true],
            'status_message'   => ['type' => 'varchar', 'constraint' => 128, 'null' => true],
